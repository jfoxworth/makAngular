	...
	public static products = [
		{
			'id' : '1',
			'featuredImageId' : '1',
			'name' : 'Ramada Clear Lake Bench',
			'designType' : 'Planter Bench',
			'designID' : 34243,
			'designIcon' : 'assets/images/mak-icons/MAKICONS-05.png',
			'status' : 'In Design',
			'price' : 3125,
			'currentVersionId' : 1,
			'images' : [],
			'description' : 'This bench is designed for the entrance lobby for the Ramada Inn in the Clear Lake, Texas. ',
			'dateLastChanged' : 'March 3, 2020',
			'dateCreated' : 'March 1, 2020',
			'handle' : '7',
			'versions' : [
				{
					'id' : 1,
					...
					'name' : 'Initial Design',
					'price' : 3000,
					'description' : 'Initial attempt at bench',
					'date' : 'Jan 1, 2020',
					'latest' : false,
					'measurements' : [
						{ 'name' : 'Left Bench Length',
						  'value' : 30
						},
						{ 'name' : 'Left Planter Depth',
						  'value' : 'Half'
						},
						{ 'name' : 'Right Bench Length',
						  'value' : 60
						},
						{ 'name' : 'Right Planter Depth',
						  'value' : 'None'
						},
					]
				},
				...
				},
				{
					'id' : 3,
					'order' : 3,					
					'name' : 'New requests from customer',
					'price' : 3125,
